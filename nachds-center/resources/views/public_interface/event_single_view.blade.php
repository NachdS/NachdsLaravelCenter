...
<!-- Copyright  event_single_view.html Nachd IT 13:31:40 GMT -->
...
<head>
    ...
    <title>Cursus - Blog Single View</title>
            ...
            <ul class="nav-list">
              ...
              <li>
                  ...
                  <ul class="nav-dropdown">
                    <li>
                      <a href="search_result-formation.html">formation 1</a>
                    </li>
                    <li>
                      <a href="search_result-formation.html">formation 2</a>
                    </li>
                    <li>
                      <a href="search_result-formation.html">formation 3</a>
                    </li>
                  </ul>
              </li>
              <li>
        ...
        <div class="_215cd2">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="back_link">
                            <a href="index.html" class="hde151">Retour Vers Accueil</a>
                        </div>
                        <div class="course_tabs margin-top-tabs">
                            <nav>
                                <div class="nav nav-tabs tab_crse  justify-content-center">
                                    <a class="nav-item nav-link active" href="about_us.html"> Détail Evénement </a>
                                </div>
                            </nav>
                        </div>
                        <div class="title129">
            ...
            <div class="container">
                <div class="row justify-content-md-center">
                    <div class="col-md-8">
                        ...
                        <div class="bg_blog2">
                            <img src="{{ asset('assets/images/blog/big_blog.jpg')}}" alt="">
                        </div>
                        ...
                        <div class="vew120 mt-35 mb-30">
                            <h4>Why did you decide to teach on Cursus?</h4>
                            <p>Nam a egestas libero, eget eleifend turpis. Sed id ipsum a ipsum aliquam laoreet sit amet
                                sit amet nibh. Proin dapibus, libero sed posuere rhoncus, orci mi cursus enim, at
                                accumsan eros massa lacinia mi. Nunc eget finibus felis, volutpat malesuada sem. Aliquam
                                ac nisl pellentesque, varius neque sit amet, porttitor nunc. Nullam elit tellus, dapibus
                                non eleifend sed, hendrerit eget velit. Aliquam ut felis dictum, tincidunt magna vitae,
                                aliquam massa. In porttitor tristique quam, non dignissim sapien pharetra ultrices. Cras
                                non ante non velit mollis mollis. Pellentesque habitant morbi tristique senectus et
                                netus et malesuada fames ac turpis egestas. Quisque et bibendum urna, eget consequat
                                sapien. Integer sed condimentum nibh. Integer id neque tristique, lobortis massa ac,
                                dapibus nibh. Donec nulla odio, porttitor ac rutrum eget, volutpat a velit. Curabitur et
                                enim quis diam congue dictum et vitae dui. Nulla tortor orci, luctus a pretium vel,
                                ultrices porta nisl.</p>
                        ...
                        <div class="vew120 mt-35 mb-30">
                            <h4>Did you have any prior on- or offline teaching experience prior to publishing your first
                                Cursus course?</h4>
