                ...
                <div class="gallery-single-view mt-50">
                  <div class="row">
                    ...
                    <div class="column">
                        ...
                        <img  class="hover-shadow" data-toggle="modal" data-target="#exampleModal" src="{{ asset($image) }}" />
                                       
                    </div>
                  <!-- Modal -->
                  <div class="modal fade hover-shadow" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
