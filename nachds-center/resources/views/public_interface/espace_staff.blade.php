                     ...
                     <div class="row">
                         <div class="col-lg-12">
                             ...
                             <div class="title589 text-center">
                                 ...
                                 <p>Le mélange parfait de professionnels du monde de l'éducation. La meilleure formule pour
                                     apprendre et progresser dans un environnement adapté !</p>
                         ...
                         <div class="col-lg-6">
                             <div class="jmio125">
                                 <p>Morbi eget elit eget turpis varius mollis eget vel massa. Donec porttitor, sapien eget
                                     commodo vulputate, erat felis aliquam dolor, non condimentum libero dolor vel ipsum.
                                     Sed
                                     porttitor nisi eget nulla ullamcorper eleifend. Fusce tristique sapien nisi, vel
                                     feugiat
                                     neque luctus sit amet. Quisque consequat quis turpis in mattis. Maecenas eget mollis
                                     nisl. Cras porta dapibus est, quis malesuada ex iaculis at. Vestibulum egestas tortor
                                     in
                                     ...
                                     sem aliquet sodales non in magna. Ut tempus ipsum sagittis neque cursus euismod.
                                     Vivamus
                     ...
                     <div class="owl-carousel top_instrutors owl-theme">
                             ...
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-1.jpg') }}" alt="" /></a>
                                 </div>
                         ...
                         <div class="item">
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-2.jpg') }}" alt="" /></a>
                                 </div>
                                 <div class="tutor_content_dt">
                                     <div class="tutor150">
                         ...
                         <div class="item">
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-3.jpg') }}" alt="" /></a>
                                 </div>
                                 <div class="tutor_content_dt">
                                     <div class="tutor150">
                         ...
                         <div class="item">
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-4.jpg') }}" alt="" /></a>
                                 </div>
                                 <div class="tutor_content_dt">
                                     <div class="tutor150">
                         ...
                         <div class="item">
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-5.jpg') }}" alt="" /></a>
                                 </div>
                                 <div class="tutor_content_dt">
                                     <div class="tutor150">
                         ...
                         <div class="item">
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-7.jpg') }}" alt="" /></a>
                                 </div>
                                 <div class="tutor_content_dt">
                                     <div class="tutor150">
                         ...
                         <div class="item">
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-8.jpg') }}" alt="" /></a>
                                 </div>
                                 <div class="tutor_content_dt">
                                     <div class="tutor150">
                         ...
                         <div class="item">
                             <div class="fcrse_1 mb-20">
                                 <div class="tutor_img">
                                     <a href="instructor_profile_view.html"><img
                                             src="{{ asset('assets/images/left-imgs/img-6.jpg') }}" alt="" /></a>
                                 </div>
                                 <div class="tutor_content_dt">
                                     <div class="tutor150">
