                                    ...
                                    <div class="fcrse_1 mt-30">
                                        <a href="{{url('/student_course_detail')}}" class="fcrse_img">
                                            ...
                                            <div class="course-overlay">
                                                <div class="badge_seller">{{  \Carbon\Carbon::parse(@$cour->created_at)->format('j F, Y')  }}</div>
                                        ...
                                        <div class="fcrse_content">
                                            ...
                                            <a href="{{url('/student_course_detail')}}" class="crse14s">{{ $cour->designation }}</a>
                                            <a href="#" class="crse-cate">Contient {{$cour->chapitres->count()}} Chapitres</a>
