...
<!-- Copyright  live_streams.html Nachd IT 13:31:32 GMT -->
...
<head>
    ...
    <title>Cursus - Listes d'élèves </title>
                            ...
                            <div class="la5lo1">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="stream_1 mb-30">
                                            <a href="live_output.html" class="stream_bg">
                                                <img src="{{ asset('assets/images/left-imgs/img-11.jpg') }}" alt="">
                                    ...
                                    <div class="col-md-2">
                                        <div class="stream_1 mb-30">
                                            <a href="live_output.html" class="stream_bg">
                                                <img src="{{ asset('assets/images/left-imgs/img-12.jpg') }}" alt="">
                                                <h4>Eli Natoli</h4>
                                                <p>live<span></span></p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="stream_1 mb-30">
                                            <a href="live_output.html" class="stream_bg">
                                                <img src="{{ asset('assets/images/left-imgs/img-13.jpg') }}" alt="">
                                    ...
                                    <div class="col-md-2">
                                        <div class="stream_1 mb-30">
                                            <a href="live_output.html" class="stream_bg">
                                                <img src="{{ asset('assets/images/left-imgs/img-14.jpg') }}" alt="">
                                                <h4>Farhat Amin</h4>
                                                <p>live<span></span></p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="stream_1 mb-30">
                                            <a href="live_output.html" class="stream_bg">
                                                <img src="{{ asset('assets/images/left-imgs/img-15.jpg') }}" alt="">
                                                <h4>Kyle Pew</h4>
                                                <p>live<span></span></p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="stream_1 mb-30">
                                            <a href="live_output.html" class="stream_bg">
                                                <img src="{{ asset('assets/images/left-imgs/img-16.jpg') }}" alt="">
                                                <h4>Kerstin Cable</h4>
                                                <p>live<span></span></p>
                                            </a>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="stream_1 mb-30">
                                            <a href="live_output.html" class="stream_bg">
                                                <img src="{{ asset('assets/images/left-imgs/img-17.jpg') }}" alt="">
                                                <h4>Jose Portilla</h4>
                                                <p>live<span></span></p>
                                            </a>
                                        </div>
...
<!-- Copyright  live_streams.html Nachd IT 13:31:33 GMT -->
