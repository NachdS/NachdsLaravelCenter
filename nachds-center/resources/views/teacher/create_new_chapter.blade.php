															...
															<div class="section-group-list sortable">
																...
																<div class="section-list-item">
																	...
																	<form action="{{ route('delete_new_chapter',$chp->id) }}" method="GET">
																		...
																		<a class="gray-s" data-toggle="modal"
																...
																<div class="modal fade" id="edit_lecture_model" tabindex="-1" aria-labelledby="lectureModalLabel" aria-hidden="true">
																	<div class="modal-dialog modal-lg">
																		<div class="modal-content">
																			<div class="modal-header">
																				<h5 class="modal-title" id="lectureModalLabel">Modifier chapitre</h5>
																				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
																					<span aria-hidden="true">&times;</span>
																				</button>
																			</div>
																			<form action="{{ route('update_new_chapter', $chp->id) }}" method="POST" enctype="multipart/form-data" accept-charset="utf-8">
																				@csrf
																				@method('PUT')
																			<div class="modal-body">
																				<div class="new-section-block">
																					<div class="row">
																						<div class="col-md-12">
																							<div class="course-main-tabs">
																								<div class="nav nav-pills flex-column flex-sm-row nav-tabs" role="tablist">
																									<a class="flex-sm-fill text-sm-center nav-link active" data-toggle="tab"
																										href="#nav-basic-edit" role="tab" aria-selected="true"><i
																											class="fas fa-file-alt mr-2"></i>Informations générales</a>
																									<a class="flex-sm-fill text-sm-center nav-link" data-toggle="tab"
																										href="#nav-attachment-edit" role="tab" aria-selected="false"><i
																											class="fas fa-paperclip mr-2"></i>Pièces jointes</a>
																								</div>
																								<div class="tab-content">
																									<div class="tab-pane fade show active" id="#nav-basic-edit" role="tabpanel">
																										...
																										<div class="new-section mt-30">
																											<div class="form_group">
																												<label class="label25"> Titre*</label>
																												<input value="{{ $chp->designation }}" name="designation" class="form_input_1" type="text" placeholder="Titre ici">
																											</div>
																										</div>
																										</div>
																										<div class="form-group">
																										<div class="new-section mt-30">
																											<div class="form_group">
																												<label class="label25"> Type*</label>
																												<input value="{{ $chp->type }}" name="type" class="form_input_1" type="text" placeholder="Type ici">
																											</div>
																										</div>
																										</div>
																										<div class="form-group">
																										<div class="ui search focus lbel25 mt-30">
																											...
																											<div class="ui form swdh30">
																												<div class="field">
																													<textarea rows="3" name="description" id=""
																														placeholder="description ici...">{{ $chp->description }}</textarea>
																												</div>
																											</div>
																										</div>
																										</div>
																									...
																									<div class="tab-pane fade" id="nav-attachment-edit" role="tabpanel">
																										<div class="row">
																											<div class="form-group col-12">
																											 <div class="col-lg-12">
																												<div class="upload-file-dt mt-30">
																													<div class="upload-btn">
																														<input multiple  type="file" value="{{@$chp->files }}" name="files[]" placeholder="Choose files" class="uploadBtn-main-input" id="SourceFile__input--source" >
																														<label for="SourceFile__input--source" title="Zip" ><i
																																class="far fa-plus-square mr-2"></i>Attachment</label>
																													</div>
																													<span class="uploadBtn-main-file">Supports: jpg, jpeg, png, pdf
																			...
																			<div class="modal-footer">
																				<button type="button" class="main-btn cancel" data-dismiss="modal">Fermer</button>
																				<button type="Submit" class="main-btn">Modifier Chapitre</button>
																			</div>
																		</form>
																		</div>
																	</div>
