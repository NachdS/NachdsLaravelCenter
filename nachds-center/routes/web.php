...
Route::get('forgot_password', function () {return view('public_interface/forgot_password');});
...
/* student */
Route::get('forgot_password', function () { return view('student/forgot_password');});
...
Route::get('explore', function () {return view('teacher/explore');});
Route::get('forgot_password', function () {return view('teacher/forgot_password');});
...
Route::get('list_eleve/{id}', [TeacherGroupeController::class, 'showById'])->name('list_eleve');
Route::get('my_instructor_profile_view', [ProfileTeacherController::class, 'show'])->name('my_instructor_profile_view');
Route::get('saved_courses', function () {return view('teacher/saved_courses');});
